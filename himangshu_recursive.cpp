/*
 ...
 Matrix Multiplication Code, Recursive
 */
...
void run_test_case(int array[], int size){
    ...
    result = recursive_matrix_chain(array, 1, size - 1);
    
    auto end_time = std::chrono::high_resolution_clock::now();
    cout<<"No. multiplications in the Optimal Chain = "<<result<<endl;
    auto running_time = end_time - start_time;
    
    cout << "Recursive Matrix Chain :: Execution Time = " <<
    chrono::duration_cast<chrono::nanoseconds>(running_time).count() << " nanoseconds"<<endl;
    
    cout<<"Recursive Matrix Chain :: No of Scalar Multiplications = "<<no_multiplications<<endl;
    cout<<"Recursive Matrix Chain :: No of Recursive Calls = "<<no_recursions<<endl;
